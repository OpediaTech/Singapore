    ...
    const organizations = [
        {
            ...
            description:"The Institute of Occupational Medicine (IOM) was founded in 1969 by the National Coal Board (NCB) as an independent charity in the UK and retains this charitable purpose and status today. The 'Institute' has a subsidiary, IOM Consulting Limited, which became fully independent in 1990 and now celebrates its 25th year within the IOM Group as an independent consultancy and also the commercial part of the IOM organization."
        },
        {
            pic:ohta,
            title:"Occupational Hygiene Training Association",
            description:"The Occupational Hygiene Association (OHTA) is a Non-Government Organisation (NGO) that was established as an international training scheme and qualifications framework which provides high-quality training materials in several languages and the infrastructure for low-cost training courses, as part of an internationally recognised programme of study."
        },
        {
            pic:occupation,
            title:"Occupational & Environmental Health Society Singapore ",
            description:"The Occupational and Environmental Health Society is a non-profit organisation dedicated to the promotion of occupational and environmental health in Singapore. "
        },
        {
            pic:hfess,
            title:"Human Factors and Ergonomics Society of Singapore",
            description:"HFESS is a special interest group to promote the awareness of Human Factors and Ergonomics (HFE) in Singapore. This society advocates the application of such knowledge to achieve compatibility in the design of interactive systems between human, machines, and environments to ensure effectiveness, safety, ease of use and performance. "
        },
        {
            pic:iiha,
            title:"Indonesian Industrial Hygiene Association ",
            description:"The Indonesian Industrial Hygiene Association (IIHA) is a voluntary, non-profit, non-governmental professional credentialing organization. IIHA was established on the 12th January 2016 and officially approved by Ministry of Human Right and Law – Republic of Indonesia by the 10th February 2016."
        },
        {
            pic:iosh,
            title:"Institution of Occupational Safety and Health",
            description:"The Institution of Occupational Safety and Health (IOSH) is the Chartered body and largest membership organisation for safety and health professionals. It act as a champion, adviser, advocate, and trainer for health and safety professionals working in organisations of all shapes and sizes, in around 130 countries."
        },
        {
            pic:asia,
            title:"Asia Pacific Occupational Safety & Health Organization",
            description:"The Asia-Pacific Occupational Safety and Health Organization (APOSHO) is an international body composed of non-profit professional organizations devoted to the prevention of occupational accidents and diseases. "
        },
        {
            pic:national,
